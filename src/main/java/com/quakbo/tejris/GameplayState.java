...
public class GameplayState extends BasicGameState 
{
    ...
    public void render( GameContainer gc, StateBasedGame sbg, Graphics g ) throws SlickException 
    {
        ...
        else
        {
            ...
            x = 345;
            y = 10;
            shapes[nextTetrad.shape].draw(x, y);
            ...
            if ( swappedTetrad != null )
            {
                x = 345;
                y = 150;
                shapes[swappedTetrad.shape].draw(x, y);
            }
    ...
    public void update( GameContainer gc, StateBasedGame sbg, int delta ) throws SlickException 
    {
        ...
        if ( tetradLanded )
        {
            ...
            {
                addHighScore();
                sbg.enterState(Tejris.GAME_OVER_STATE, new FadeOutTransition(Color.black), new FadeInTransition(Color.black));
            }
     ...
     * 
     * @return the Tetrad from the swap area if possible. 
     */
    public void getSwappedTetrad()
    {
        if ( swappedTetrad != null )
        {
            Tetrad newTetrad = new Tetrad(NEW_TETRAD_ROW, NEW_TETRAD_COL, swappedTetrad.shape, swappedTetrad.orientation, sprites);
    ...
    public void pollKeyboard( GameContainer gc, StateBasedGame sbg )
    {
        ...
        // MOVE RIGHT
        else if ( input.isKeyDown(Input.KEY_RIGHT) && timeSinceKeyRepeat > KEY_REPEAT_DELAY )
        {
            timeSinceKeyRepeat = 0;
        ...
        // ROTATE RIGHT
        else if ( ( input.isKeyDown(Input.KEY_C) || input.isKeyDown(Input.KEY_UP) )
                 && timeSinceKeyRepeat > KEY_REPEAT_DELAY )
        {
            timeSinceKeyRepeat = 0;
